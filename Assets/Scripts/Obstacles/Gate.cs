...
public class Gate : MonoBehaviour
{
    ...
    public void ExecuteOperation()
    {
        ...
        {
            GameEvents.instance.slidingDuration.Value += value;
        }

        if (gateOperation == OperationType.difference && GameEvents.instance.slidingDuration.Value > 0)
            GameEvents.instance.slidingDuration.Value -= value;
        ...
        if (gateOperation == OperationType.division && GameEvents.instance.slidingDuration.Value > 0)
            GameEvents.instance.slidingDuration.Value /= value;
